const fs = require('fs');
   ...
   class Circle extends Shape {
     ...
     renderSVG(filePath) {
      ...
      <circle cx="150" cy="100" r="80" ${this.border ? `stroke-width="3" stroke="${this.color}" ` : ''}fill="${this.bgColor}" />
...
class Square extends Shape{
    ...
    renderSVG(filePath) {
       ...
       <rect x="50" width="200" height="200" ${this.border ? `stroke-width="3" stroke="${this.color}" ` : ''}fill="${this.bgColor}" />
...
class Triangle extends Shape{
    ...
    renderSVG(filePath) {
       ...
       <path d="M 150 30 L 270 170 L 30 170 Z" ${this.border ? `stroke-width="3" stroke="${this.color}" ` : ''}fill="${this.bgColor}" />
